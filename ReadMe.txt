...
4) Copy the following required jars from <TEAMCENTER_SERVICES_HOME>\java\libs to 
    ...
    TcSoaClient_10000.1.0.jar
    TcSoaCommon_10000.1.0.jar
    TcSoaCoreStrong_10000.1.0.jar
    TcSoaCoreTypes_10000.1.0.jar
    TcSoaQueryStrong_10000.1.0.jar
    TcSoaQueryTypes_10000.1.0.jar
    TcSoaStrongModel_10000.1.0.jar
    xercesImpl.jar
